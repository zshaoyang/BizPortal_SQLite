<%@ Page Language="C#" AutoEventWireup="false" Inherits="BizPortal.AdminUI.AddCategoryPage" %>
        ...
        <div id="main">
            <div class="inner">
                <div class="main_title">
                    <strong><%=LangRes.Text("AddProductCategoryData") %></strong>
                    <span><a href="<%=ADMIN_URL("ProductCategoryManagerPage") %>" class="more_link"><%=LangRes.Text("ManageList") %></a></span>
                </div>
                <div class="main_content">
                    <form id="EditorForm" action="<%=API_URL("AdminCategoryHandler") %>?action=100" method="post" enctype="multipart/form-data">
                    <table class="editor_table" cellpadding="0" cellspacing="0">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="4" style="text-align:center;">
                                    <input type="submit" value="<%=LangRes.Text("AddProductCategoryData") %>" class="submit" />
                                </td>
                            </tr>
                        </tfoot>
                    </table>
...
<!-- #include file="../includes/_footer.html" -->
    ...
    <script type="text/javascript">
        var TextTips = new FormTextTip({
            "txtCategoryUrlName": "<%=LangRes.Text("FriendlyURL") %>-http://<%=LangRes.Text("DomainName") %><%=URL("CategoryPage", "{" + LangRes.Text("UrlName") + "}") %>",
