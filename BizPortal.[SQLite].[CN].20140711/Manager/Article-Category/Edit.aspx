<%@ Page Language="C#" AutoEventWireup="false" Inherits="BizPortal.AdminUI.EditArticleCategoryPage" %>
        ...
        <div id="main">
            <div class="inner">
                <div class="main_title">
                    <strong><%=LangRes.Text("UpdateArticleCategoryData") %></strong>
                ...
                <div class="main_content">
                    <form id="EditorForm" action="<%=API_URL("AdminCategoryHandler") %>?action=501" method="post" enctype="multipart/form-data">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="4" style="text-align:center;">
                                    ...
                                    <input type="submit" value="<%=LangRes.Text("UpdateArticleCategoryData") %>" class="submit" />
                                </td>
                            </tr>
                        </tfoot>
                    </table>
