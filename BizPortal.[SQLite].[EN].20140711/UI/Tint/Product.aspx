...
<!-- #include file="includes/_head.html" -->
    ...
    <div id="main" class="wrap">
        ...
        <div id="content">
            ...
            <div class="panel">
                <div class="bar">
                    <h4 class="title"><%=BlockSetting.ProductDetailPageBlockTitle %></h4>
                </div>
                <div class="box">
...
<!-- #include file="includes/_pager.html" -->
                ...
                <div id="post_comment_box" class="box comment_panel_item post_comment_panel none">
                    <div class="box_inner">
                        <form id="PostCommentForm" action="<%=API_URL("OperationHandler") %>?action=100" method="post" enctype="application/x-www-form-urlencoded" onsubmit="$('#SubmitComment').attr('disabled',true);">
